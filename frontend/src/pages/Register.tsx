...
export const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#F0EDE8] relative overflow-hidden px-4 font-sans">
      {/* Background accents */}
      <div className="absolute -top-32 -right-20 w-[450px] h-[450px] bg-teal-200/15 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute -bottom-32 -left-20 w-[400px] h-[400px] bg-amber-100/20 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-stone-400 pointer-events-none"><User size={16} /></span>
                <input
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-stone-400 pointer-events-none"><Mail size={16} /></span>
                <input
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-stone-400 pointer-events-none"><Lock size={16} /></span>
                <input
          ...
          <div className="text-center mt-6">
            <p className="text-stone-500 text-sm">
              ...
              <Link to="/login" className="text-teal-700 hover:underline font-semibold transition-colors">
                Sign in
              </Link>
            </p>
          </div>
