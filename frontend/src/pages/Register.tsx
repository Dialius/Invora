    ...
    <div className="flex items-center justify-center min-h-screen bg-[#FAF9F5] relative overflow-hidden px-4 font-sans">
      ...
      <div className="w-full max-w-md bg-white border border-slate-200/80 rounded-2xl p-8 md:p-10 shadow-xl shadow-slate-200/50 relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 font-serif">Create account</h2>
          <p className="text-slate-500 text-sm mt-1.5">Get started with Invora invoicing today</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-slate-500 text-sm">
            ...
            <Link to="/login" className="text-teal-600 hover:underline hover:text-teal-700 font-semibold transition-colors">
              Sign in
            </Link>
          </p>
        </div>
